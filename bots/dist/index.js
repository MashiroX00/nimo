...
import { handleDockerAction, handleDockerSelect, handleDockerStopModal, } from './services/dockerInteractions.js';
const bootstrap = async () => {
    ...
    const commandCollection = new Collection(commands);
    ...
    client.on(Events.InteractionCreate, async (interaction) => {
        try {
            ...
            if (interaction.isRepliable()) {
                const content = `Unexpected error: ${error.message}`;
